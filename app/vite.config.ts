  ...
  return {
    ...
    writeBundle(options) {
      ...
      const vrouwen = readFileSync(resolve(map, "index.html"), "utf8")
        ...
        .replaceAll("icon-retro-192.png", "icon-vrouwen-gelijk-192.png")
        .replaceAll('sizes="180x180" href="icon-retro-180.png"', 'sizes="180x180" href="icon-vrouwen-gelijk-180.png"')
