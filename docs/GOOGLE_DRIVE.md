...
Deze wijziging publiceert alleen de accountkoppeling. Bestaande wedstrijdalbums blijven
op Supabase Storage tot de Drive-upload-, afspeel- en verwijderfuncties gereed zijn.
De volledige Google-toestemming moet nog door de beheerder worden afgerond.
...
Validatie: 53 bestaande apptests, appbuild en Deno-typecontrole geslaagd.
